...
@section('title', 'Acorn Admin Template | Blog')
@section('description', 'Service Provider Blog')
...
<div class="row">
  ...
  <div class="col-12 col-xxl-8 mb-5">
    <div class="card mb-5">
      <a href="#">
        <img src="{{ asset('img/blog/blog-image-1.webp') }}" class="card-img-top sh-35 theme-filter" alt="card image" />
      </a>
      <div class="card-body">
        <h4 class="mb-3">
          ...
          <div class="col-6">
            <div class="d-flex align-items-center">
              <div class="sw-5 d-inline-block position-relative me-3">
                <img src="{{ asset('img/profile/profile-1.webp') }}" class="img-fluid rounded-xl" alt="thumb" />
              </div>
    ...
    <div class="card mb-5">
      <a href="#">
        <img src="{{ asset('img/blog/blog-image-2.webp') }}" class="card-img-top sh-35 theme-filter" alt="card image" />
      </a>
      <div class="card-body">
        <h4 class="mb-3">
    ...
    <div class="card mb-5">
      <a href="#">
        <img src="{{ asset('img/blog/blog-image-3.webp') }}" class="card-img-top sh-35 theme-filter" alt="card image" />
      </a>
      <div class="card-body">
        <h4 class="mb-3">
    ...
    <div class="card mb-5">
      <a href="#">
        <img src="{{ asset('img/blog/blog-image-4.webp') }}" class="card-img-top sh-35 theme-filter" alt="card image" />
      </a>
      <div class="card-body">
        <h4 class="mb-3">
