...
@section('title', 'Acorn Admin Template | Knowledge Base')
@section('description', 'Service Provider Knowledge Base')
...
<div class="page-title-container mb-3">
  <div class="row">
    <!-- Title Start -->
    <div class="col mb-2">
      <h1 class="mb-2 pb-0 display-4" id="title">Knowledge Base</h1>
              ...
              <div class="mb-n2">
                <div class="row g-0 mb-2">
                  ...
                  <div class="col lh-1-25">
                    <a href="{{ route('support.docs.detail') }}" class="alternate-link">Chocolate cake marshmallow muffin</a>
                  </div>
                </div>
                <div class="row g-0 mb-2">
                  <div class="col-auto">
                  ...
                  <div class="col lh-1-25">
                    <a href="{{ route('support.docs.detail') }}" class="alternate-link">Bear claw marzipan tiramisu topping</a>
                  </div>
                </div>
                <div class="row g-0 mb-2">
                  <div class="col-auto">
                  ...
                  <div class="col lh-1-25">
                    <a href="{{ route('support.docs.detail') }}" class="alternate-link">Gingerbread biscuit bear claw marzipan tiramisu topping</a>
                  </div>
                </div>
                <div class="row g-0 mb-2">
                  <div class="col-auto">
                  ...
                  <div class="col lh-1-25">
                    <a href="{{ route('support.docs.detail') }}" class="alternate-link">
            ...
            <div class="card-body d-flex flex-column pe-0 pt-0 pb-0 h-100 justify-content-start">
              ...
              <div class="mb-n2">
                <div class="row g-0 mb-2">
                  ...
                  <div class="col lh-1-25">
                    <a href="{{ route('support.docs.detail') }}" class="alternate-link">Wafer halvah chocolate soufflé icing</a>
                  </div>
                </div>
                <div class="row g-0 mb-2">
                  <div class="col-auto">
                ...
                <div class="row g-0 mb-2">
                  ...
                  <div class="col lh-1-25">
                    <a href="{{ route('support.docs.detail') }}" class="alternate-link">Gingerbread chocolate cake tootsie marzipan tiramisu topping</a>
                  </div>
                </div>
                <div class="row g-0 mb-2">
                  <div class="col-auto">
                  ...
                  <div class="col lh-1-25">
                    <a href="{{ route('support.docs.detail') }}" class="alternate-link">Sweet roll cupcake dragée croissant</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card-body d-flex flex-column pe-0 pt-0 pb-0 h-100 justify-content-start">
              ...
              <div class="mb-n2">
                ...
                <div class="row g-0 mb-2">
                  ...
                  <div class="col lh-1-25">
                    <a href="{{ route('support.docs.detail') }}" class="alternate-link">Croissant chocolate bar croissant drops gingerbread</a>
                  </div>
                </div>
                <div class="row g-0 mb-2">
                  <div class="col-auto">
                  ...
                  <div class="col lh-1-25">
                    <a href="{{ route('support.docs.detail') }}" class="alternate-link">Marzipan bear claw marzipan tiramisu topping</a>
                  </div>
                </div>
                <div class="row g-0 mb-2">
                  <div class="col-auto">
                  ...
                  <div class="col lh-1-25">
                    <a href="{{ route('support.docs.detail') }}" class="alternate-link">Sweet roll cupcake dragée croissant muffin</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card-body d-flex flex-column pe-0 pt-0 pb-0 h-100 justify-content-start">
              ...
              <div class="mb-n2">
                <div class="row g-0 mb-2">
                  ...
                  <div class="col lh-1-25">
                    <a href="{{ route('support.docs.detail') }}" class="alternate-link">Chupa chups marshmallow muffin liquorice</a>
                  </div>
                </div>
                <div class="row g-0 mb-2">
                  <div class="col-auto">
                ...
                <div class="row g-0 mb-2">
                  ...
                  <div class="col lh-1-25">
                    <a href="{{ route('support.docs.detail') }}" class="alternate-link">Dragée croissant muffin</a>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="row g-2">
        ...
        <div class="card">
          <a href="#" class="row g-0 sh-11">
            <div class="col-auto h-100">
              <img src="{{ asset('img/video/video-thumbnail-5.webp') }}" alt="alternate text" class="card-img card-img-horizontal sw-14 theme-filter" />
      ...
      <div class="col-12 col-md-6 col-xl-12">
        <div class="card">
          <a href="#" class="row g-0 sh-11">
            <div class="col-auto h-100">
              <img src="{{ asset('img/video/video-thumbnail-2.webp') }}" alt="alternate text" class="card-img card-img-horizontal sw-14 theme-filter" />
      ...
      <div class="col-12 col-md-6 col-xl-12">
        <div class="card">
          <a href="#" class="row g-0 sh-11">
            <div class="col-auto h-100">
              <img src="{{ asset('img/video/video-thumbnail-3.webp') }}" alt="alternate text" class="card-img card-img-horizontal sw-14 theme-filter" />
      ...
      <div class="col-12 col-md-6 col-xl-12">
        <div class="card">
          <a href="#" class="row g-0 sh-11">
            <div class="col-auto h-100">
              <img src="{{ asset('img/video/video-thumbnail-4.webp') }}" alt="alternate text" class="card-img card-img-horizontal sw-14 theme-filter" />
      ...
      <div class="col-12 col-md-6 col-xl-12">
        <div class="card">
          <a href="#" class="row g-0 sh-11">
            <div class="col-auto h-100">
              <img src="{{ asset('img/video/video-thumbnail-6.webp') }}" alt="alternate text" class="card-img card-img-horizontal sw-14 theme-filter" />
