...
@section('title', 'Acorn Admin Template | Docs')
@section('description', 'Service Provider Docs')
...
<div class="row">
    ...
    <div class="card">
      <div class="card-body sh-45 d-flex align-items-center justify-content-center">
        <div class="text-center">
          <img src="{{ asset('img/illustration/access-token.webp') }}" class="theme-filter" alt="access" />
          <div class="cta-3">No access token!</div>
          <div class="cta-5 text-primary mb-4">Would you like to create one?</div>
          <a href="{{ route('support.docs.detail') }}" class="btn btn-primary">CREATE TOKEN</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="col-12 col-lg-8 mb-5">
    ...
    <div class="card sh-45 bg-transparent theme-filter-player">
      <video class="player cover" poster="{{ asset('img/video/video-large.webp') }}">
        ...
        <div class="row row-cols-2 row-cols-xl-3 gy-5" id="apiReferenceMasonry">
          <div class="col">
            <div class="card no-shadow">
              ...
              <a href="{{ route('support.docs.detail') }}" class="d-flex flex-row mb-2 alternate-link">
                <div class="sw-4"></div>
    ...
    <div class="card mb-2 h-100">
      <div class="card-body row g-0">
        <div class="col-12">
          ...
          <a href="{{ route('support.docs.detail') }}" class="btn btn-icon btn-icon-start btn-outline-primary stretched-link">
    ...
    <div class="card mb-2 h-100">
      <div class="card-body row g-0">
        <div class="col-12">
          ...
          <div class="text-muted mb-4">Cheesecake chocolate carrot cake pie lollipop lemon toffee lollipop. Oat cake pie cake cotton.</div>
          <a href="{{ route('community') }}" class="btn btn-icon btn-icon-start btn-outline-primary stretched-link">
    ...
    <div class="card mb-2 h-100">
      <div class="card-body row g-0">
        <div class="col-12">
          ...
          <a href="{{ route('support.knowledge.base') }}" class="btn btn-icon btn-icon-start btn-outline-primary stretched-link">
    ...
    <div class="card mb-2 h-100">
      <div class="card-body row g-0">
        <div class="col-12">
          ...
          <div class="text-muted mb-4">Cheesecake chocolate carrot cake pie lollipop lemon toffee lollipop. Oat cake pie cake cotton.</div>
          <a href="{{ route('support.tickets') }}" class="btn btn-icon btn-icon-start btn-outline-primary stretched-link">
...
<script src="{{ asset('js/pages/support.docs.js') }}"></script>
@endpush