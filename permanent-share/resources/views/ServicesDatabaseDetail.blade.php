...
@section('title', 'Acorn Admin Template | Database Detail')
@section('description', 'Service Provider Database Detail')
...
<script src="{{ asset('js/pages/services.databasedetail.js') }}"></script>
@endpush