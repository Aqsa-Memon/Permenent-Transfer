...
@section('title', 'Acorn Admin Template | Settings')
@section('description', 'Service Provider Settings')
  ...
  <div class="card-body">
    <form class="d-flex flex-column mb-4">
      <div class="mb-3 mx-auto position-relative" id="singleImageUploadExample">
        <img
          src="{{ asset('img/profile/profile-9.webp') }}"
          alt="alternate text"
...
<script src="{{ asset('js/pages/account.settings.js') }}"></script>
@endpush