...
@section('title', 'Acorn Admin Template | Hosting')
@section('description', 'Service Provider Hosting')
...
<div class="page-title-container mb-3">
  <div class="row">
    <!-- Title Start -->
    <div class="col mb-2">
      <h1 class="mb-2 pb-0 display-4" id="title">Hosting</h1>
      ...
      <div class="col-12 col-lg-6 h-100">
        <div class="card h-100">
          <div class="card-body d-flex flex-column justify-content-between">
            ...
            <a href="{{ route('support.docs') }}" class="btn btn-icon btn-icon-start btn-outline-primary stretched-link sw-15">
      ...
      <div class="col-12 col-lg-6 h-100">
        <div class="card h-100">
          <div class="card-body d-flex flex-column justify-content-between">
            ...
            <a href="{{ route('community') }}" class="btn btn-icon btn-icon-start btn-outline-primary stretched-link sw-15">
