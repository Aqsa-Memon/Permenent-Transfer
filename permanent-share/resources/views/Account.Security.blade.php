...
@section('title', 'Acorn Admin Template | Security')
@section('description', 'Service Provider Security')
        ...
        <div class="card-body">
          <div class="row g-0">
            <div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
              <img src="{{ asset('img/illustration/icon-email.webp') }}" class="theme-filter" alt="email icon" />
            </div>
    ...
    <div class="col">
      <div class="card">
        ...
        <div class="card-body">
          <div class="row g-0">
            <div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
              <img src="{{ asset('img/illustration/access-token.webp') }}" class="theme-filter" alt="access token" />
            </div>
            <div class="col-12 col-sm">
    ...
    <div class="col">
      <div class="card">
        ...
        <div class="card-body">
          <div class="row g-0">
            <div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
              <img src="{{ asset('img/illustration/icon-phone.webp') }}" class="theme-filter" alt="phone" />
            </div>
            <div class="col-12 col-sm">
