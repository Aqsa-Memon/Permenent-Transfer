...
@section('title', 'Acorn Admin Template | Ticket Detail')
@section('description', 'Service Provider Ticket Detail')
      ...
      <div class="card-body">
        <div class="mb-4 pb-4 border-bottom border-separator-light">
          <div class="row g-0 sh-sm-5 h-auto">
            <div class="col-auto">
              <img src="{{ asset('img/profile/profile-9.webp') }}" class="card-img rounded-xl sh-5 sw-5" alt="thumb" />
            </div>
            <div class="col ps-3">
        ...
        <div class="mb-4 pb-4 border-bottom border-separator-light">
          <div class="row g-0 sh-sm-5 h-auto">
            <div class="col-auto">
              <img src="{{ asset('img/profile/profile-8.webp') }}" class="card-img rounded-xl sh-5 sw-5" alt="thumb" />
            </div>
            <div class="col ps-3">
              <div class="row h-100 g-2">
                <div class="col h-sm-100 d-flex flex-column justify-content-sm-center mb-1 mb-sm-0">
...
<script src="{{ asset('js/pages/support.ticketsdetail.js') }}"></script>
@endpush