...
@section('title', 'Acorn Admin Template | Upgrade')
@section('description', 'Service Provider Upgrade')
  ...
  <div class="row">
    ...
    <div class="col mb-2">
      <a href="{{ route('upgrade') }}">
        <h1 class="mb-2 pb-0 display-4" id="title">Upgrade</h1>
      </a>
      ...
      <div class="card h-100 hover-scale-up">
        ...
        <div class="card-footer pt-0 border-0">
          ...
          <div class="d-flex justify-content-center">
            <a href="{{ route('upgrade') }}" class="btn btn-icon btn-icon-start btn-foreground hover-outline stretched-link">
        ...
        <div class="card-body">
          <div class="row g-0">
            <div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
              <img src="{{ asset('img/illustration/icon-performance.webp') }}" class="w-auto sw-md-14 sw-xl-11 img-fluid theme-filter" alt="performance" />
            </div>
    ...
    <div class="col">
      <div class="card h-100">
        <div class="card-body">
          <div class="row g-0">
            <div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
              <img src="{{ asset('img/illustration/icon-configure.webp') }}" class="w-auto sw-md-14 sw-xl-11 img-fluid theme-filter" alt="configure" />
            </div>
            <div class="col-12 col-sm">
    ...
    <div class="col">
      <div class="card h-100">
        <div class="card-body">
          <div class="row g-0">
            <div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
              <img src="{{ asset('img/illustration/icon-database.webp') }}" class="w-auto sw-md-14 sw-xl-11 img-fluid theme-filter" alt="database" />
            </div>
            <div class="col-12 col-sm">
    ...
    <div class="col">
      <div class="card h-100">
        <div class="card-body">
          <div class="row g-0">
            <div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
              <img src="{{ asset('img/illustration/icon-experiment.webp') }}" class="w-auto sw-md-14 sw-xl-11 img-fluid theme-filter" alt="experiment" />
            </div>
            <div class="col-12 col-sm">
