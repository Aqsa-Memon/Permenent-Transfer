...
@section('title', 'Acorn Admin Template | Database Add')
@section('description', 'Service Provider Database Add')
...
<div class="page-title-container mb-3">
  <div class="row">
    <!-- Title Start -->
    <div class="col mb-2">
      <h1 class="mb-2 pb-0 display-4" id="title">New Database</h1>
...
<script src="{{ asset('js/pages/services.databaseadd.js') }}"></script>
@endpush