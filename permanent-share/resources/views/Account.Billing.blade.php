...
@section('title', 'Acorn Admin Template | Billing')
@section('description', 'Service Provider Billing')
      ...
      <div class="card-body h-100">
        <div class="row g-0">
          <div class="col-12 col-sm-auto pe-4 d-flex justify-content-center">
            <img src="{{ asset('img/illustration/icon-integrate.webp') }}" alt="integrate" class="theme-filter" />
          </div>
