...
@section('title', 'Acorn Admin Template | Community')
@section('description', 'Service Provider Community')
      ...
      <div class="row g-2 row-cols-1 row-cols-md-2">
          ...
          <div class="card h-100">
            <div class="card-body">
              <div class="text-center mb-3">
                <img src="{{ asset('img/illustration/icon-storage.webp') }}" class="theme-filter" alt="storage" />
                <div class="d-flex flex-column sh-5">
                  <a href="{{ route('community.list') }}" class="heading stretched-link">Storage</a>
                </div>
              </div>
        ...
        <div class="col">
          <div class="card h-100">
            <div class="card-body">
              <div class="text-center mb-3">
                <img src="{{ asset('img/illustration/icon-server.webp') }}" class="theme-filter" alt="server" />
                <div class="d-flex flex-column sh-5">
                  <a href="{{ route('community.list') }}" class="heading stretched-link">Hosting</a>
                </div>
              </div>
              <div class="row g-0 mb-n2">
                <div class="col-6 col-sm-3 mb-2">
        ...
        <div class="col">
          <div class="card h-100">
            <div class="card-body">
              <div class="text-center mb-3">
                <img src="{{ asset('img/illustration/icon-database.webp') }}" class="theme-filter" alt="database" />
                <div class="d-flex flex-column sh-5">
                  <a href="{{ route('community.list') }}" class="heading stretched-link">Database</a>
                </div>
              </div>
              <div class="row g-0 mb-n2">
                <div class="col-6 col-sm-3 mb-2">
        ...
        <div class="col">
          <div class="card h-100">
            <div class="card-body">
              <div class="text-center mb-3">
                <img src="{{ asset('img/illustration/icon-accounts.webp') }}" class="theme-filter" alt="accounts" />
                <div class="d-flex flex-column sh-5">
                  <a href="{{ route('community.list') }}" class="heading stretched-link">Accounts</a>
                </div>
              </div>
              <div class="row g-0 mb-n2">
                <div class="col-6 col-sm-3 mb-2">
        ...
        <div class="col">
          <div class="card h-100">
            <div class="card-body">
              <div class="text-center mb-3">
                <img src="{{ asset('img/illustration/icon-analytics.webp') }}" class="theme-filter" alt="analytics" />
                <div class="d-flex flex-column sh-5">
                  <a href="{{ route('community.list') }}" class="heading stretched-link">Analytics</a>
                </div>
              </div>
              <div class="row g-0 mb-n2">
                <div class="col-6 col-sm-3 mb-2">
        ...
        <div class="col">
          <div class="card h-100">
            <div class="card-body">
              <div class="text-center mb-3">
                <img src="{{ asset('img/illustration/icon-support.webp') }}" class="theme-filter" alt="support" />
                <div class="d-flex flex-column sh-5">
                  <a href="{{ route('community.list') }}" class="heading stretched-link">Support</a>
                </div>
              </div>
              <div class="row g-0 mb-n2">
                <div class="col-6 col-sm-3 mb-2">
          ...
          <div class="row g-0">
            <div class="col-auto d-none d-sm-flex pe-4">
              <div class="sw-5">
                <div class="text-center mb-2">
                  <a href="#" class="{{ $i === 0 || $i === 3 ? 'primary-link' : 'muted-link' }}">
                    <i data-acorn-icon="arrow-top"></i>
                  </a>
                </div>
                <div class="cta-2 text-alternate text-center mb-2">
                  {{ $i === 0 ? '214' : ($i === 1 ? '105' : ($i === 2 ? '105' : ($i === 3 ? '42' : '53'))) }}
                </div>
            ...
            <div class="col">
              <div class="position-relative mb-4">
                <a href="{{ route('community.list') }}" class="heading d-block body-link stretched-link mb-3">
                  @if($i === 0)
                  ...
                  @else
                    Lemon drops marzipan
                  @endif
                </a>
                @if($i === 1)
                  <img alt="detail" src="{{ asset('img/product/large/product-1.webp') }}" class="rounded img-fluid sh-50 w-100" />
                @else
                  <p class="text-alternate mb-0">
                    @if($i === 0)
                      Topping cotton candy halvah marshmallow jujubes chupa chups macaroon cookie croissant. Marshmallow tiramisu marshmallow gummi bears dragée oat cake fruitcake dessert. Topping bonbon gingerbread chocolate apple pie cheesecake liquorice muffin pudding.
                    @elseif($i === 2)
                      Brownie topping apple pie pie toffee wafer cookie bonbon sweet roll. Marshmallow sugar plum chupa chups tart brownie dessert lemon drops topping chocolate. Jelly dragée apple pie halvah jujubes. Sweet sugar plum wafer carrot cake jelly chocolate bar. Brownie gummi bears wafer brownie. Caramels sesame snaps apple pie fruitcake cheesecake topping lemon drops gummi bears icing.
                    @elseif($i === 3)
                      Marshmallow beans ice cream candy canes sugar plum chupa chups tart brownie dessert lemon drops topping chocolate. Jelly dragée apple pie halvah jujubes.
                    @else
              ...
              <div class="row g-0">
                <div class="col-12 col-sm mb-3 mb-sm-0">
                  <div class="row g-0 sh-4">
                    <div class="col-auto pe-2">
                      <img src="{{ asset('img/profile/profile-' . ($i === 0 ? '4' : ($i === 1 || $i === 2 ? '3' : ($i === 3 ? '2' : '7'))) . '.webp') }}" class="card-img rounded-xl sh-4 sw-4" alt="thumb" />
                    </div>
                    <div class="col d-flex align-items-center">
                      {{ $i === 0 ? 'Cherish Kerr' : ($i === 1 || $i === 2 ? 'Kathryn Mengel' : ($i === 3 ? 'Esperanza Lodge' : 'Joisse Kaycee')) }}
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-auto text">
                  <div class="d-inline-block me-3">
                    ...
                    <span class="align-middle">{{ $i === 0 ? '239' : ($i === 1 ? '114' : ($i === 2 ? '245' : ($i === 3 ? '321' : '53'))) }}</span>
                  </div>
                  <div class="d-inline-block">
                    <i data-acorn-icon="message" class="text-primary me-1" data-acorn-size="15"></i>
                    <span class="align-middle">{{ $i === 0 ? '8' : ($i === 1 ? '21' : ($i === 2 ? '12' : ($i === 3 ? '4' : '17'))) }}</span>
                  </div>
  ...
  <div class="col-12 col-xxl-4 mb-n5">
    ...
    <div class="card mb-5">
      <div class="card-body mb-n2">
        @php
          $topUsers = [
            ['profile' => '1', 'name' => 'Cherish Kerr', 'score' => '7.8K'],
            ['profile' => '9', 'name' => 'Kirby Peters', 'score' => '6.1K'],
            ['profile' => '7', 'name' => 'Olli Hawkins', 'score' => '5.7K'],
            ['profile' => '8', 'name' => 'Zayn Hartley', 'score' => '5.6K'],
            ['profile' => '2', 'name' => 'Vin Lodge', 'score' => '5.2K']
          ];
        @endphp
        @foreach($topUsers as $index => $user)
        <div class="row g-0 sh-5 mb-2">
          <div class="col-auto">
            <img src="{{ asset('img/profile/profile-' . $user['profile'] . '.webp') }}" class="card-img rounded-xl sh-5 sw-5" alt="thumb" />
          </div>
          <div class="col">
            <div class="card-body d-flex flex-row pt-0 pb-0 ps-3 pe-0 h-100 align-items-center justify-content-between">
              ...
              <div class="d-flex align-items-center">
                <span class="text-muted me-2 d-inline-block">{{ $user['score'] }}</span>
