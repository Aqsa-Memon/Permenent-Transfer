...
@section('title', 'Acorn Admin Template | Users')
@section('description', 'Service Provider Users')
...
<div class="row row-cols-1 row-cols-md-3 row-cols-xxl-4 g-2">
    ...
    <div class="card h-100">
      <div class="card-body pb-0">
        <div class="d-flex flex-column align-items-center mb-5">
          <img class="sw-9 sh-9 rounded-xl mb-3" src="{{ asset('img/profile/profile-1.webp') }}" alt="card image" />
  ...
  <div class="col">
    <div class="card h-100">
      <div class="card-body pb-0">
        <div class="d-flex flex-column align-items-center mb-5">
          <img class="sw-9 sh-9 rounded-xl mb-3" src="{{ asset('img/profile/profile-2.webp') }}" alt="card image" />
  ...
  <div class="col">
    <div class="card h-100">
      <div class="card-body pb-0">
        <div class="d-flex flex-column align-items-center mb-5">
          <img class="sw-9 sh-9 rounded-xl mb-3" src="{{ asset('img/profile/profile-3.webp') }}" alt="card image" />
  ...
  <div class="col">
    <div class="card h-100">
      <div class="card-body pb-0">
        <div class="d-flex flex-column align-items-center mb-5">
          <img class="sw-9 sh-9 rounded-xl mb-3" src="{{ asset('img/profile/profile-9.webp') }}" alt="card image" />
  ...
  <div class="col">
    <div class="card h-100">
      <div class="card-body pb-0">
        <div class="d-flex flex-column align-items-center mb-5">
          <img class="sw-9 sh-9 rounded-xl mb-3" src="{{ asset('img/profile/profile-5.webp') }}" alt="card image" />
  ...
  <div class="col">
    <div class="card h-100">
      <div class="card-body pb-0">
        <div class="d-flex flex-column align-items-center mb-5">
          <img class="sw-9 sh-9 rounded-xl mb-3" src="{{ asset('img/profile/profile-8.webp') }}" alt="card image" />
