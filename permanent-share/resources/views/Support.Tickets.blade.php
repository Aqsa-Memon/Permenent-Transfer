...
@section('title', 'Acorn Admin Template | Tickets')
@section('description', 'Service Provider Tickets')
...
<div class="row">
  <div class="col-12 mb-5">
    ...
    <div class="mb-n2">
      <a href="{{ route('support.tickets.detail') }}" class="card mb-2 sh-22 sh-md-8 hover-border-primary">
        <div class="card-body pt-0 pb-0 h-100">
          <div class="row g-0 h-100 align-content-center">
