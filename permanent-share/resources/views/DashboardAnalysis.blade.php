...
@section('title', 'Acorn Admin Template | Analysis')
@section('description', 'Service Provider Analysis')
      ...
      <div class="scroll-by-count" data-count="4">
        ...
        <div class="card mb-2">
          <div class="card-body py-0 sh-10 sh-md-8">
            <div class="row g-0 h-100 align-content-center">
              <div class="col-12 col-md-9 d-flex align-items-center mb-2 mb-md-0">
                <a href="{{ route('home') }}" class="alternate-link text-truncate">/classic-dashboard/Interface.Forms.Controls.DatePicker.html</a>
              </div>
        ...
        <div class="card mb-2">
          <div class="card-body py-0 sh-10 sh-md-8">
            <div class="row g-0 h-100 align-content-center">
              <div class="col-12 col-md-9 d-flex align-items-center mb-2 mb-md-0">
                <a href="{{ route('home') }}" class="alternate-link text-truncate">/dashboard/getting-started</a>
              </div>
        ...
        <div class="col-12">
          ...
          <div class="row g-2">
            ...
            <div class="col-12 col-sm-auto d-flex align-items-center position-relative">
              <a href="{{ route('upgrade') }}" class="btn btn-icon btn-icon-start btn-primary">
...
<script src="{{ asset('js/pages/dashboard.analysis.js') }}"></script>
@endpush