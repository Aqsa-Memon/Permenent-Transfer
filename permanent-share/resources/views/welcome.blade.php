...
<div class="row">
  ...
  <div class="col-12 col-lg-8 mb-5">
    <div class="card sh-45 h-lg-100 position-relative bg-theme">
      <img src="{{ asset('img/illustration/database.webp') }}" class="card-img h-100 position-absolute theme-filter" alt="card image" />
    ...
    <div class="scroll-out">
      <div class="scroll-by-count" data-count="4">
        <div class="card mb-2 hover-border-primary">
          <a href="{{ route('services.database.add') }}" class="row g-0 sh-9">
            <div class="col-auto">
        ...
        <div class="card mb-2 hover-border-primary">
          <a href="{{ route('services.storage') }}" class="row g-0 sh-9">
            <div class="col-auto">
              <div class="sw-9 sh-9 d-inline-block d-flex justify-content-center align-items-center">
                <div class="fw-bold text-primary">
        ...
        <div class="card mb-2 hover-border-primary">
          <a href="{{ route('account.security') }}" class="row g-0 sh-9">
            <div class="col-auto">
              <div class="sw-9 sh-9 d-inline-block d-flex justify-content-center align-items-center">
                <div class="fw-bold text-primary">
        ...
        <div class="card mb-2 hover-border-primary">
          <a href="{{ route('services.metrics') }}" class="row g-0 sh-9">
            <div class="col-auto">
              <div class="sw-9 sh-9 d-inline-block d-flex justify-content-center align-items-center">
                <div class="fw-bold text-primary">
        ...
        <div class="card mb-2 hover-border-primary">
          <a href="{{ route('support.docs') }}" class="row g-0 sh-9">
            <div class="col-auto">
              <div class="sw-9 sh-9 d-inline-block d-flex justify-content-center align-items-center">
                <div class="fw-bold text-primary">
  ...
  <div class="row g-2 row-cols-1 row-cols-xl-2 row-cols-xxl-4">
      ...
      <div class="card h-100">
        <div class="card-body">
          <div class="text-center">
            <img src="{{ asset('img/illustration/icon-launch.webp') }}" class="theme-filter" alt="launch" />
            <div class="d-flex flex-column sh-5">
              <a href="{{ route('support.knowledge.base') }}" class="heading stretched-link">Application Launch</a>
            </div>
          </div>
    ...
    <div class="col">
      <div class="card h-100">
        <div class="card-body">
          <div class="text-center">
            <img src="{{ asset('img/illustration/icon-performance.webp') }}" class="theme-filter" alt="performance" />
            <div class="d-flex flex-column sh-5">
              <a href="{{ route('support.knowledge.base') }}" class="heading stretched-link">Performance Tweaks</a>
            </div>
          </div>
    ...
    <div class="col">
      <div class="card h-100">
        <div class="card-body">
          <div class="text-center">
            <img src="{{ asset('img/illustration/icon-configure.webp') }}" class="theme-filter" alt="configure" />
            <div class="d-flex flex-column sh-5">
              <a href="{{ route('support.knowledge.base') }}" class="heading stretched-link">Advanced Configuration</a>
            </div>
          </div>
      ...
      <div class="card h-100">
        <div class="card-body">
          <div class="text-center">
            ...
            <div class="d-flex flex-column sh-5">
              <a href="{{ route('support.knowledge.base') }}" class="heading stretched-link">Server Analytics</a>
            </div>
          </div>
    ...
    <div class="row g-2">
        ...
        <div class="card">
          <a href="{{ route('blog') }}" class="row g-0 sh-11">
            <div class="col-auto h-100">
              <img src="{{ asset('img/video/video-thumbnail-1.webp') }}" alt="alternate text" class="card-img card-img-horizontal sw-11 sw-md-14 theme-filter" />
      ...
      <div class="col-12 col-lg-6">
        <div class="card">
          <a href="{{ route('blog') }}" class="row g-0 sh-11">
            <div class="col-auto h-100">
              <img src="{{ asset('img/video/video-thumbnail-2.webp') }}" alt="alternate text" class="card-img card-img-horizontal sw-11 sw-md-14 theme-filter" />
            ...
            <div class="col">
              <div class="card-body d-flex flex-column pt-0 pb-0 h-100 justify-content-center">
                <div class="d-flex flex-column">
                  ...
                  <div class="text-small text-muted text-truncate">Jujubes cream toffee candy jelly chups jujubes muffin chupa chups carrot cake chupa.</div>
                </div>
              </div>
            </div>
          </a>
      ...
      <div class="col-12 col-lg-6">
        <div class="card">
          <a href="{{ route('blog') }}" class="row g-0 sh-11">
            <div class="col-auto h-100">
              <img src="{{ asset('img/video/video-thumbnail-3.webp') }}" alt="alternate text" class="card-img card-img-horizontal sw-11 sw-md-14 theme-filter" />
      ...
      <div class="col-12 col-lg-6">
        <div class="card">
          <a href="{{ route('blog') }}" class="row g-0 sh-11">
            <div class="col-auto h-100">
              <img src="{{ asset('img/video/video-thumbnail-5.webp') }}" alt="alternate text" class="card-img card-img-horizontal sw-11 sw-md-14 theme-filter" />
      ...
      <div class="col-12 col-lg-6">
        <div class="card">
          <a href="{{ route('blog') }}" class="row g-0 sh-11">
            <div class="col-auto h-100">
              <img src="{{ asset('img/video/video-thumbnail-6.webp') }}" alt="alternate text" class="card-img card-img-horizontal sw-11 sw-md-14 theme-filter" />
